...
@section('content')
    ...
    <section class="service-section mt-5" id="service">
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-xl-2 col-lg-2 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                ...
                <div class="col-xl-2 col-lg-2 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                    <div class="service-card-items text-center style-2">
                        ...
                        <div class="content">
                            <h5>
                                <a href="service-details.html">
                                    Konsultasikan Design <br>
                                    Yang ingin digunakan kepad kami
                                </a>
                            </h5>
                        </div>
                    </div>
                ...
                <div class="col-xl-2 col-lg-2 col-md-6 wow fadeInUp" data-wow-delay=".9s">
                    <div class="service-card-items text-center style-2">
                        ...
                        <div class="content">
                            <h5>
                                <a href="service-details.html">
                                    Design di cetak untuk <br>
                                    persetujuan akhir warna, gambar dan bentuk
                                </a>
                            </h5>
                        </div>
                    </div>
                ...
                <div class="col-xl-2 col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="1.1s">
                    <div class="service-card-items text-center style-2">
                        ...
                        <div class="content">
                            <h5>
                                <a href="service-details.html">
                                    Proses produksi masal <br>
                                    Pengharum mobil dilakukan
                                </a>
                            </h5>
                        </div>
                    </div>
    ...
    <section class="team-section fix section-padding section-bg">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p>
                    leh karena banyaknya permintaaan, kami juga melayani pembuatan packaging untuk
                    pengharum mobil custom Anda. Jenis packaging yang kami sediakan adalah tipe A1, A2,
                    dan A3 (lihat pada gambar dibawah). Masing - masing packaging memiliki spesifikasi
                    dan harga yang berbeda. Hubungi kami jika Anda tertarik untuk mengetahui informasi
                    lebih lanjut.

                    Packaging adalah sarana yang tepat untuk menaikan nilai daripada pengharum mobil
                    anda. dengan packaging, tampilan produk menjadi lebih rapih dan profesional. Anda
                    dapat memilih 2 jenis finishing, yaitu Glossy dan Doff Berikut merupakan contoh
                    hasil jadi packaging pada beberapa project customparfummobil.id
                </p>
            </div>
            <div class="row">
