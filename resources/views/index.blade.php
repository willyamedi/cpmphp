            ...
            <div class="marquee-inner to-left">
                <ul class="marqee-list d-flex">
                    <li class="marquee-item">
                        <span class="text-slider">WE</span><span class="text-slider">CREATE</span><span
                            class="text-slider">UNIQUE</span><span class="text-slider">CUSTOMIZE</span><span
                            class="text-slider">CAR PERFUME</span><span class="text-slider">WE</span><span
                            class="text-slider">CREATE</span><span class="text-slider">UNIQUE</span><span
                            class="text-slider">CUSTOMIZE</span><span class="text-slider">PERFUME MERCHANDISE</span><span
                            class="text-slider">WE</span><span class="text-slider">CREATE</span><span
                            class="text-slider">UNIQUE</span><span class="text-slider">BRAND</span><span
                            class="text-slider">MERCHANDISE</span>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="project-items-2 style-2">
                            <div class="project-image">
                                ...
                                <div class="project-content">
                                    <p>Indonesia</p>
                                    <h4>
                                        <a href="project-details.html">PT Pertamina Patra Niaga</a>
                                    </h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="project-items-2 style-2">
                            <div class="project-image">
                                ...
                                <div class="project-content">
                                    <p>Jakarta</p>
                                    <h4>
                                        <a href="project-details.html">Honda motor indonesia</a>
                                    </h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="project-items-2 style-2">
                            <div class="project-image">
                                ...
                                <div class="project-content">
                                    <p>Jakarta</p>
                                    <h4>
                                        <a href="project-details.html">ACC Astra</a>
                                    </h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="project-items-2 style-2">
                            <div class="project-image">
                                ...
                                <div class="project-content">
                                    <p>Jakarta</p>
                                    <h4>
                                        <a href="project-details.html">Khong Guan Biscuit</a>
                                    </h4>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="choose-content">
                            ...
                            <p class="mt-4 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                                Kami adalah produsen pewangi mobil custom yang telah berdiri sejak 2018 dan telah di percaya
                                oleh ribuan customer. Kami sudah melewati berbagai proses trial error di awal hingga
                                akhirnya berhasil memberikan kualitas terbaik untuk para klien kami. Kami menawarkan
                                pengharum mobil dengan kualitas terbaik yang ada di pasar, yang dapat menjadi sarana
                            ...
                            <div class="icon-area">
                                <div class="icon-items wow fadeInUp" data-wow-delay=".3s">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            Bahan baku yang kami gunakan memiliki daya serap tinggi,<br />
                                            serta lebih tebal dibanding dengan yang beredar di pasaran.
                                        </p>
                                    </div>
                                </div>
                                <div class="icon-items style-2 wow fadeInUp" data-wow-delay=".5s">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            Menggunakan pengharum bersertifikat, menggunakan bahan yang aman
                                            dan tidak berbahaya bagi kesehatan, <br />serta aroma yang dapat bertahan cukup
                                            lama.
                                        </p>
                                    </div>
                                </div>
                                <div class="icon-items style-2 wow fadeInUp" data-wow-delay=".5s">
                                    ...
                                    <div class="content">
                                        <h5>Harga terbaik</h5>
                                        <p>
                                            Kami produsen langsung, tanpa perantara, <br />
                                            Anda akan mendapatkan harga yang sangat kompetitif.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="icon-items style-2 wow fadeInUp" data-wow-delay=".5s">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>
                                            Produk kami bergaransi dari kesalahan produksi, seberapa banyakpun orderan Anda,
                                            jika ada kekeliruan dan cacat produksi,<br /> akan kami tanggung sepenuhnya.
                    ...
                    <div class="col-xl-6 col-lg-6 mt-5 mt-lg-0">
                        <div class="choose-image-items">
                            <div class="choose-image bg-cover wow fadeInUp" data-wow-delay=".3s"
                                style="background-image: url('assets/img/choose/01.jpg')"></div>
    ...
    <section class="website-checking section-padding fix bg-cover" style="background-image: url('assets/img/bg.jpg')">
        <div class="container">
            <div class="section-title text-center">
                <span class="text-white wow fadeInUp">Tertarik untuk mengetahui lebih lanjut?</span>
