 ...
 <footer
 class="footer-section style-2 fix bg-cover"
 ...
 <div class="container">
   <div class="footer-widgets-wrapper">
     <div class="row">
       ...
       >
         <div class="single-footer-widget">
           ...
           <div class="footer-content">
             <p>
               Green Village blok boulevard D no 5 <br />Jl. KH Hasyim
       ...
       ></div>
       <div
         class="col-xl-3 ps-lg-5 col-lg-4 col-md-6 wow fadeInUp"
         data-wow-delay=".7s"
       ></div>
       <div
 ...
 <div class="footer-bottom">
   <div class="container">
     <div class="footer-bottom-wrapper">
       <p>Copyright © 2024 Customparfummobil.id</p>
